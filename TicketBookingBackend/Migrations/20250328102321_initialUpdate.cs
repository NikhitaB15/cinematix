    ...
    public partial class initialUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AuditLog__5E5486489ADF88AB", x => x.LogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Theaters__4D68B219E0435063", x => x.TheaterId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4C393F37A0", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Seats__311713F3CEED5817", x => x.SeatId);
                    table.ForeignKey(
                        name: "FK__Seats__TheaterId__44FF419A",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowDateTime = table.Column<DateTime>(type: "datetime", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shows__6DE3E0B280C3D06A", x => x.ShowId);
                    table.ForeignKey(
                        name: "FK__Shows__TheaterId__412EB0B6",
                        column: x => x.TheaterId,
                        principalTable: "Theaters",
                        principalColumn: "TheaterId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Bookings__73951AEDE907A3E7", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK__Bookings__SeatId__52593CB8",
                        column: x => x.SeatId,
                        principalTable: "Seats",
                        principalColumn: "SeatId");
                    table.ForeignKey(
                        name: "FK__Bookings__ShowId__5165187F",
                        column: x => x.ShowId,
                        principalTable: "Shows",
                        principalColumn: "ShowId");
                    table.ForeignKey(
                        name: "FK__Bookings__UserId__5070F446",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reviews__74BC79CE30C51355", x => x.ReviewId);
                    table.ForeignKey(
                        name: "FK__Reviews__ShowId__628FA481",
                        column: x => x.ShowId,
                        principalTable: "Shows",
                        principalColumn: "ShowId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Reviews__UserId__619B8048",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Payments__9B556A3855E53887", x => x.PaymentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Transact__55433A6B1A721BED", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK__Transacti__Booki__5CD6CB2B",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Transacti__UserI__5BE2A6F2",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Payments__55433A6AC5FFDF61",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D10534EA80FCF4",
                table: "Users",
                column: "Email",
                unique: true);
        }
